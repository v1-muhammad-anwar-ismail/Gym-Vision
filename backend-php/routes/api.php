...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Exercise Categories
    Route::get('/exercise-categories', [\App\Http\Controllers\ExerciseCategoryController::class, 'index']);

    // Rep Counter
    Route::post('/rep-counter/run', [\App\Http\Controllers\RepCounterController::class, 'run']);
    Route::post('/rep-counter/stop', [\App\Http\Controllers\RepCounterController::class, 'stop']);
    Route::post('/rep-counter/save-history', [\App\Http\Controllers\RepCounterController::class, 'saveHistory']);
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Exercise Categories
        Route::post('/exercise-categories', [\App\Http\Controllers\ExerciseCategoryController::class, 'store']);
        Route::delete('/exercise-categories/{id}', [\App\Http\Controllers\ExerciseCategoryController::class, 'destroy']);
    });
});
