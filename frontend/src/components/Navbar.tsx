    ...
    <>
          ...
          <div className="navbar-links-desktop">
            ...
            {user && (
              <>
                ...
                <Link to="/dashboard/rep-counter" className={`nav-link ${path === '/dashboard/rep-counter' ? 'active' : ''}`}>
                  {t('nav_rep_counter')}
                </Link>
              </>
            )}
      ...
      <div className={`navbar-menu-mobile ${isMenuOpen ? 'active' : ''}`}>
        ...
        <div className="navbar-links-mobile">
          ...
          {user && (
            <>
              <Link to="/dashboard" className={`nav-link ${path.startsWith('/dashboard') && path !== '/dashboard/rep-counter' ? 'active' : ''}`} onClick={() => setIsMenuOpen(false)}>
                {t('nav_dashboard')}
              </Link>
              <Link to="/analysis" className={`nav-link ${path === '/analysis' ? 'active' : ''}`} onClick={() => setIsMenuOpen(false)}>
                {t('nav_analysis')}
              </Link>
              <Link to="/dashboard/rep-counter" className={`nav-link ${path === '/dashboard/rep-counter' ? 'active' : ''}`} onClick={() => setIsMenuOpen(false)}>
                {t('nav_rep_counter')}
              </Link>
            </>
          )}
